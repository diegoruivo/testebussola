                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select name="group" class="custom-select">
                                        <option value=""  {{ (old('group') == '' ? 'selected' : '') }}>Selecione a Turma</option>
                                        @foreach($groups as $group)
                                            @if (!empty($selected_group))
                                                <option value="{{ $group->id }}" {{ ($group->id === $selected_group->id ? 'selected' : '') }}>{{ $group->title }}</option>
                                            @else
                            ...
                            <div class="col-sm-4 mb-4">
                                ...
                                <div class="icheck-primary offset-sm-1 d-inline">
                                    <input type="checkbox" id="checkboxPrimary2"
                                           name="student" {{ (old('student') == 'on' || old('student') == true ? 'checked' : '') }}>
