                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <a href="{{ route('admin.users.create') }}">
                                <button type="button" class="btn bg-gradient-primary ml-3"><i class="fa fa-plus"></i> Cadastrar Aluno</button>
                            </a>
                        </ol>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($users as $user)
                            ...
                            if(empty($user->group()->first()->title)){ $group = ''; } else { $group = $user->group()->first()->title; }
                            @endphp
                            <tr>
                                <td>{{ $user->id }}</td>
